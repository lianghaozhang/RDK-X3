...
// {
//   RCLCPP_INFO(this->get_logger(), "订阅到的上位机信号: %d", sign_switch->data);
...
{
    // double odom_offset_x = 1.0;
    // double odom_offset_y = 1.0;
    // 定义参数并初始化
    // this->declare_parameter<double_t>("odom_offset_x", odom_offset_x);
    // this->declare_parameter<double_t>("odom_offset_y", odom_offset_y);
    // this->get_parameter("odom_offset_x", odom_offset_x);
    // this->get_parameter("odom_offset_y", odom_offset_y);
    ...
    // ===================================================
    // 校准里程计
    odom.pose.pose.position.x = Robot_Pos.X * 1.118;
    odom.pose.pose.position.y = Robot_Pos.Y * 1.912;
    // odom.pose.pose.position.y = Robot_Pos.Y * 1.049;
    // odom.pose.pose.position.x = Robot_Pos.X * odom_offset_x;
    // odom.pose.pose.position.y = Robot_Pos.Y * odom_offset_y;
    // ===================================================
    // ===================================================
    // ===================================================
    // ===================================================
...
origincar_base::origincar_base() : rclcpp::Node ("origincar_base")
{
  memset(&Robot_Pos, 0, sizeof(Robot_Pos));
  memset(&Robot_Vel, 0, sizeof(Robot_Vel));
